...
import { LayoutDashboard, UserCircle, CreditCard, Settings, ExternalLink, ShieldCheck, X } from 'lucide-react'
...
export function DashboardSidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  const navItems = [
    ...
    { label: 'Botones Hotmart', href: '/dashboard/buttons', icon: CreditCard },
    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800/80 space-y-2">
          ...
          >
            <span className="truncate">Ver mi perfil público</span>
