...
export function PublicFooter() {
  return (
    <footer className="mt-auto w-full shrink-0 border-t border-slate-200 bg-slate-50 py-5 transition-colors dark:border-slate-800/80 dark:bg-slate-950 sm:py-6">
