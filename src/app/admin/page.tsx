  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 space-y-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {(pendingReports ?? 0) > 0 && (
          <div className="flex items-center gap-3 p-4 rounded-xl bg-rose-500/5 border border-rose-500/20 text-rose-600 dark:text-rose-400">
            ...
            <p className="text-sm">
              ...
              <Link href="/admin/reports" className="underline font-semibold">Revisar ahora</Link>
            </p>
          </div>
        )}
        ...
        <div className="p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/20 text-xs text-indigo-700 dark:text-indigo-400">
          <p>
            <strong>Fase 8 parcial:</strong> El panel de administración avanzado (búsqueda, filtros, acciones de desactivación y reportes detallados) se completará en la Fase 8 del roadmap.
          </p>
        </div>
      </div>
    </div>
